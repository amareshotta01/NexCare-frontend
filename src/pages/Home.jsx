              ...
              <div>
                <div className='lg:w-[570px] '>
                  <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
                    We will help patients live a healthy, longer life.
                  </h1>
                  <p className='text__para'>
                  With a focus on prevention, treatment, and ongoing support, our goal is to empower individuals to thrive in every aspect of their health journey. Discover personalized care, compassion, and confidence with our dedicated team at your side, ensuring a brighter, healthier future for all.
                  </p>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get virtual treatment <br/> at anytime.
              </h2>
              <ul className="pl-4">
