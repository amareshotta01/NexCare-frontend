...
const Profile = ({ doctorData }) => {
  ...
  const delQualification = (e, index) => {
    e.preventDefault();
    ...
    <div>
      ...
      <form>
          ...
          {formData.qualifications?.map((item, index) => (
            <div key={index}>
              <div>
                ...
                <button
                  onClick={(e) => delQualification(e, index)}
        ...
        <div className="mb-5 flex items-center gap-3">
          {formData.photo && (
            <figure className="w-[65px] h-[65px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
              <img
                src={formData.photo}
                alt=""
